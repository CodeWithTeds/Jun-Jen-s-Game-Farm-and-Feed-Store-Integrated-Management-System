<x-layouts.app>
    ...
    <div class="bg-white dark:bg-slate-900 overflow-hidden shadow-sm sm:rounded-lg border border-slate-200 dark:border-slate-700 p-6">
        <form method="POST" action="{{ route($routePrefix . 'chick-rearings.update', $chickRearing) }}">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input id="hatch_date" type="date" name="hatch_date" value="{{ old('hatch_date', $chickRearing->hatch_date->format('Y-m-d')) }}" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300 dark:focus:border-emerald-500 transition-shadow" required />
                    @error('hatch_date')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input id="age_days" type="number" name="age_days" value="{{ old('age_days', $chickRearing->age_days) }}" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300 dark:focus:border-emerald-500 transition-shadow" required min="0" />
                    @error('age_days')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <select id="growth_stage" name="growth_stage" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300 dark:focus:border-emerald-500 transition-shadow">
                        <option value="Brooder" {{ old('growth_stage', $chickRearing->growth_stage) == 'Brooder' ? 'selected' : '' }}>Brooder</option>
                        <option value="Starter" {{ old('growth_stage', $chickRearing->growth_stage) == 'Starter' ? 'selected' : '' }}>Starter</option>
                        <option value="Grower" {{ old('growth_stage', $chickRearing->growth_stage) == 'Grower' ? 'selected' : '' }}>Grower</option>
                    </select>
                    @error('growth_stage')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input id="feed_type" type="text" name="feed_type" value="{{ old('feed_type', $chickRearing->feed_type) }}" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300 dark:focus:border-emerald-500 transition-shadow" required />
                    @error('feed_type')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input id="feeding_schedule" type="text" name="feeding_schedule" value="{{ old('feeding_schedule', $chickRearing->feeding_schedule) }}" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300 dark:focus:border-emerald-500 transition-shadow" required />
                ...
                <div>
                    ...
                    <input id="last_vaccination_date" type="date" name="last_vaccination_date" value="{{ old('last_vaccination_date', $chickRearing->last_vaccination_date ? $chickRearing->last_vaccination_date->format('Y-m-d') : '') }}" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300 dark:focus:border-emerald-500 transition-shadow" />
                ...
                <div>
                    ...
                    <select id="mortality_status" name="mortality_status" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300 dark:focus:border-emerald-500 transition-shadow">
                        <option value="Alive" {{ old('mortality_status', $chickRearing->mortality_status) == 'Alive' ? 'selected' : '' }}>Alive</option>
                        <option value="Deceased" {{ old('mortality_status', $chickRearing->mortality_status) == 'Deceased' ? 'selected' : '' }}>Deceased</option>
                    </select>
            ...
            <div class="mt-6">
                ...
                <textarea id="treatment_notes" name="treatment_notes" rows="3" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300 dark:focus:border-emerald-500 transition-shadow">{{ old('treatment_notes', $chickRearing->treatment_notes) }}</textarea>
            ...
            <div class="mt-6">
                ...
                <textarea id="remarks" name="remarks" rows="3" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300 dark:focus:border-emerald-500 transition-shadow">{{ old('remarks', $chickRearing->remarks) }}</textarea>
                @error('remarks')
                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                @enderror
            </div>
