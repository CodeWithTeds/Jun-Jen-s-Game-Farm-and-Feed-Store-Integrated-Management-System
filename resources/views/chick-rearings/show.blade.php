                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <div class="flex gap-2">
                            <a href="{{ route($routePrefix . 'chick-rearings.edit', $chickRearing) }}" class="inline-flex items-center px-4 py-2 bg-emerald-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-emerald-700 focus:bg-emerald-700 active:bg-emerald-900 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                {{ __('Edit') }}
                            </a>
                            <a href="{{ route($routePrefix . 'chick-rearings.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 transition ease-in-out duration-150 dark:bg-gray-200 dark:text-gray-800 dark:hover:bg-white">
                                {{ __('Back to List') }}
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="bg-gray-50 dark:bg-slate-900 p-4 rounded-lg">
                            <h4 class="font-semibold mb-2 text-emerald-600 dark:text-emerald-400">{{ __('Basic Information') }}</h4>
                        ...
                        <div class="bg-gray-50 dark:bg-slate-900 p-4 rounded-lg">
                            <h4 class="font-semibold mb-2 text-emerald-600 dark:text-emerald-400">{{ __('Feeding & Health') }}</h4>
                            <div class="grid grid-cols-2 gap-2 text-sm">
                    ...
                    <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                         <div class="bg-gray-50 dark:bg-slate-900 p-4 rounded-lg">
                            <h4 class="font-semibold mb-2 text-emerald-600 dark:text-emerald-400">{{ __('Treatment Notes') }}</h4>
                            <p class="text-sm text-gray-700 dark:text-gray-300 whitespace-pre-line">{{ $chickRearing->treatment_notes ?? 'No notes available.' }}</p>
                        </div>

                        <div class="bg-gray-50 dark:bg-slate-900 p-4 rounded-lg">
                            <h4 class="font-semibold mb-2 text-emerald-600 dark:text-emerald-400">{{ __('Remarks') }}</h4>
