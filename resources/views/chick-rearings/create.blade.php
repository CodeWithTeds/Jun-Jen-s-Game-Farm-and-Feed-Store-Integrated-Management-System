        ...
        <form method="POST" action="{{ route($routePrefix . 'chick-rearings.store') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="chick_tag_id" name="chick_tag_id" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300 dark:focus:border-emerald-500 transition-shadow" required autofocus>
                        <option value="">Select Batch/Tag</option>
                        @foreach($hatcheryRecords as $record)
                            @php $tagId = 'Batch-EC-' . $record->egg_collection_id; @endphp
                            <option value="{{ $tagId }}" {{ old('chick_tag_id') == $tagId ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <select id="health_status" name="health_status" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300 dark:focus:border-emerald-500 transition-shadow">
                        ...
                        <option value="Weak / Underweight" {{ old('health_status') == 'Weak / Underweight' ? 'selected' : '' }}>Weak / Underweight</option>
                ...
                <div>
                    ...
                    <select id="vaccination_status" name="vaccination_status" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300 dark:focus:border-emerald-500 transition-shadow">
                        <option value="" disabled selected>Select Status</option>
                        <option value="N/A" {{ old('vaccination_status') == 'N/A' ? 'selected' : '' }}>N/A</option>
