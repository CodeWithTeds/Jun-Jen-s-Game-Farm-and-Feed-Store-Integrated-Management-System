...
@if($sidebar)
    <flux:sidebar.brand name="Jun & Jen's Shop" {{ $attributes }}>
        <x-slot name="logo" class="flex aspect-square size-16 items-center justify-center rounded-md bg-white overflow-hidden shadow-sm border border-emerald-100 dark:border-emerald-800">
