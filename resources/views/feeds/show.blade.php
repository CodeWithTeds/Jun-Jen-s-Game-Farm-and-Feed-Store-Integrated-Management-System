    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route($routePrefix . 'products.edit', $feed->id) }}" wire:navigate class="inline-flex items-center px-4 py-2 bg-emerald-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-emerald-700 focus:bg-emerald-700 active:bg-emerald-900 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 transition ease-in-out duration-150">
                    {{ __('Edit') }}
                </a>
                @endif
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-slate-800 overflow-hidden shadow-sm sm:rounded-lg border border-slate-200 dark:border-slate-700 p-6">
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <!-- Left Column: Image -->
                    <div class="space-y-6">
                        <div class="aspect-w-1 aspect-h-1 w-full overflow-hidden rounded-lg bg-gray-200 dark:bg-slate-700 xl:aspect-w-7 xl:aspect-h-8">
                        ...
                        <div class="bg-gray-50 dark:bg-slate-900 p-4 rounded-lg border border-slate-100 dark:border-slate-700/50">
                            <h4 class="font-semibold mb-3 text-emerald-600 dark:text-emerald-400 border-b border-slate-200 dark:border-slate-700 pb-2">{{ __('Quick Status') }}</h4>
                            <div class="space-y-3">
                                <div>
                    ...
                    <div class="lg:col-span-2 space-y-6">
                         <div class="bg-gray-50 dark:bg-slate-900 p-6 rounded-lg border border-slate-100 dark:border-slate-700/50">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="bg-gray-50 dark:bg-slate-900 p-6 rounded-lg border border-slate-100 dark:border-slate-700/50">
                                ...
                                <div class="text-sm text-gray-700 dark:text-gray-300 whitespace-pre-line bg-white dark:bg-slate-800 p-3 rounded border border-gray-100 dark:border-slate-700">
