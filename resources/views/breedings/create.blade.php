<x-layouts.app>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('staff.breedings.index') }}" wire:navigate class="inline-flex items-center px-4 py-2 bg-white dark:bg-slate-800 border border-gray-300 dark:border-slate-700 rounded-lg font-medium text-sm text-gray-700 dark:text-gray-300 shadow-sm hover:bg-gray-50 dark:hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 transition ease-in-out duration-150">
                        ...
                        <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="relative group">
                                ...
                                <div class="relative">
                                    ...
                                    <select name="sire_id" id="sire_id" class="pl-8 mt-1 block w-full rounded-lg border-gray-300 dark:border-slate-700 dark:bg-slate-900/50 dark:text-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm py-2.5 transition-colors" required>
                            ...
                            <div class="relative group">
                                ...
                                <div class="relative">
                                    ...
                                    <select name="dam_id" id="dam_id" class="pl-8 mt-1 block w-full rounded-lg border-gray-300 dark:border-slate-700 dark:bg-slate-900/50 dark:text-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm py-2.5 transition-colors" required>
                    ...
                    <div class="bg-white dark:bg-slate-900 shadow-sm rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden">
                        ...
                        <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div>
                                ...
                                <input type="date" name="breeding_date" id="breeding_date" value="{{ old('breeding_date') }}" class="mt-1 block w-full rounded-lg border-gray-300 dark:border-slate-700 dark:bg-slate-900/50 dark:text-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm py-2.5" required>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="type" id="type" class="mt-1 block w-full rounded-lg border-gray-300 dark:border-slate-700 dark:bg-slate-900/50 dark:text-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm py-2.5" required>
                            ...
                            <div>
                                ...
                                <select name="status" id="status" class="mt-1 block w-full rounded-lg border-gray-300 dark:border-slate-700 dark:bg-slate-900/50 dark:text-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm py-2.5" required>
                        ...
                        <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div>
                                ...
                                <div class="relative rounded-md shadow-sm">
                                    ...
                                    <input type="text" name="pen_number" id="pen_number" value="{{ old('pen_number') }}" class="pl-10 mt-1 block w-full rounded-lg border-gray-300 dark:border-slate-700 dark:bg-slate-900/50 dark:text-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm py-2.5" placeholder="e.g. A-101" required>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="clutch_number" id="clutch_number" value="{{ old('clutch_number') }}" class="mt-1 block w-full rounded-lg border-gray-300 dark:border-slate-700 dark:bg-slate-900/50 dark:text-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm py-2.5" placeholder="Optional">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" name="expected_hatch_date" id="expected_hatch_date" value="{{ old('expected_hatch_date') }}" class="mt-1 block w-full rounded-lg border-gray-300 dark:border-slate-700 dark:bg-slate-900/50 dark:text-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm py-2.5">
                            </div>
                        </div>
                    </div>
