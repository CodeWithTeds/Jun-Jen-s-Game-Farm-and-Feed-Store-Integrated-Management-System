<x-layouts.app>
    <div class="flex items-center justify-between mb-6">
        ...
        @endphp
        <a href="{{ route($routePrefix . 'feed-usages.create') }}" class="inline-flex items-center px-4 py-2 bg-emerald-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-emerald-700 focus:bg-emerald-700 active:bg-emerald-900 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 transition ease-in-out duration-150">
            {{ __('Record Usage') }}
        </a>
    </div>
    ...
    <div class="mb-6 bg-white dark:bg-slate-900 p-4 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
        <form method="GET" action="{{ route($routePrefix . 'feed-usages.index') }}" class="flex flex-wrap gap-4 items-end">
            ...
            <div class="w-40">
                <label for="feed_id" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Feed</label>
                <select id="feed_id" name="feed_id" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300 dark:focus:border-emerald-500 transition-shadow">
            ...
            <div class="w-40">
                <label for="chick_rearing_id" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Chick Group</label>
                <select id="chick_rearing_id" name="chick_rearing_id" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300 dark:focus:border-emerald-500 transition-shadow">
