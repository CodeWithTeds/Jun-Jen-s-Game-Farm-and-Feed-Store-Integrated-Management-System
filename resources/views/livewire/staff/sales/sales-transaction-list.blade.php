<div class="p-6">
    <div class="mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button wire:click="exportReport" class="inline-flex items-center justify-center gap-2 rounded-lg border border-transparent bg-emerald-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 transition-colors">
