...
<body class="bg-slate-50 font-sans text-slate-900 antialiased">
    ...
    <span class="font-bold text-xl text-emerald-700 tracking-tight">Jun & Jen’s</span>
                    ...
                    <div class="hidden md:ml-10 md:flex md:space-x-8">
                        ...
                        <a href="#gallery" class="text-slate-500 hover:text-emerald-600 px-3 py-2 text-sm font-medium transition-colors">Gallery</a>
                    </div>
                </div>
            ...
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                <div class="text-center lg:text-left">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        ...
                        <a href="#gallery" class="bg-white hover:bg-slate-50 text-slate-700 border border-slate-200 px-8 py-3.5 rounded-lg text-base font-semibold transition-all shadow-sm hover:shadow-md">
                            View Gallery
                        </a>
                    </div>
                </div>
    ...
    <section id="about" class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-3xl mx-auto text-center">
                <h2 class="text-3xl font-bold text-slate-900 mb-6">Streamlined Operations</h2>
                ...
                <div class="grid md:grid-cols-3 gap-8 mt-16">
                    <div class="p-6 bg-slate-50 rounded-xl hover:shadow-lg transition-shadow">
                        ...
                        <p class="text-slate-500 text-sm">Efficiently track and manage all farm activities and livestock.</p>
                    </div>
                    <div class="p-6 bg-slate-50 rounded-xl hover:shadow-lg transition-shadow">
                        ...
                        <p class="text-slate-500 text-sm">Real-time tracking of feed, supplies, and equipment.</p>
                    </div>
                    <div class="p-6 bg-slate-50 rounded-xl hover:shadow-lg transition-shadow">
                        ...
                        <p class="text-slate-500 text-sm">Secure access control tailored to specific user roles and tasks.</p>
                    </div>
                </div>
            </div>
        </div>
