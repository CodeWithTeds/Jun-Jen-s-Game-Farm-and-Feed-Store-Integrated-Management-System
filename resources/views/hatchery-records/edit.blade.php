                    ...
                    <div class="bg-white dark:bg-zinc-900 shadow-sm rounded-xl border border-zinc-200 dark:border-zinc-800 overflow-hidden">
                        ...
                        <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <input type="text" name="turning_schedule" id="turning_schedule" value="{{ old('turning_schedule', $hatcheryRecord->turning_schedule) }}" class="block w-full rounded-lg border-gray-300 dark:border-zinc-700 dark:bg-zinc-900/50 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm py-2.5" required>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" step="0.1" name="temperature" id="temperature" value="{{ old('temperature', $hatcheryRecord->temperature) }}" class="block w-full rounded-lg border-gray-300 dark:border-zinc-700 dark:bg-zinc-900/50 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm py-2.5" required>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" step="0.1" name="humidity" id="humidity" value="{{ old('humidity', $hatcheryRecord->humidity) }}" class="block w-full rounded-lg border-gray-300 dark:border-zinc-700 dark:bg-zinc-900/50 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm py-2.5" required>
                            </div>
                    ...
                    <div class="bg-white dark:bg-zinc-900 shadow-sm rounded-xl border border-zinc-200 dark:border-zinc-800 overflow-hidden">
                        ...
                        <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <input type="date" name="candling_date" id="candling_date" value="{{ old('candling_date', $hatcheryRecord->candling_date) }}" class="block w-full rounded-lg border-gray-300 dark:border-zinc-700 dark:bg-zinc-900/50 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm py-2.5">
                            </div>

                            <!-- Fertility Rate -->
                            <div>
                                <label for="fertility_rate" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Fertility Rate (%)</label>
                                <input type="number" step="0.01" name="fertility_rate" id="fertility_rate" value="{{ old('fertility_rate', $hatcheryRecord->fertility_rate) }}" class="block w-full rounded-lg border-gray-300 dark:border-zinc-700 dark:bg-zinc-900/50 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm py-2.5">
                            </div>
                            
                            <!-- Hatch Rate -->
                            <div>
                                <label for="hatch_rate" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Hatch Rate (%)</label>
                                <input type="number" step="0.01" name="hatch_rate" id="hatch_rate" value="{{ old('hatch_rate', $hatcheryRecord->hatch_rate) }}" class="block w-full rounded-lg border-gray-300 dark:border-zinc-700 dark:bg-zinc-900/50 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm py-2.5">
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="remarks" id="remarks" rows="3" class="block w-full rounded-lg border-gray-300 dark:border-zinc-700 dark:bg-zinc-900/50 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm py-2.5">{{ old('remarks', $hatcheryRecord->remarks) }}</textarea>
                            </div>
                        </div>
                    </div>
