<x-layouts.app>
    ...
    <div class="bg-white dark:bg-slate-900 overflow-hidden shadow-sm sm:rounded-lg border border-slate-200 dark:border-slate-700 p-6">
        <form action="{{ route($routePrefix . 'game-fowls.update', $gameFowl) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-emerald-500 transition-colors dark:border-slate-700 dark:hover:border-emerald-500 relative group cursor-pointer" onclick="document.getElementById('image').click()">
                            <div class="space-y-1 text-center">
                                ...
                                <div id="upload-placeholder" class="{{ $gameFowl->image ? 'hidden' : '' }}">
                                    ...
                                    <div class="flex text-sm text-gray-600 dark:text-gray-400 justify-center">
                                        <span class="relative cursor-pointer bg-white rounded-md font-medium text-emerald-600 hover:text-emerald-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-emerald-500 dark:bg-slate-900 dark:text-emerald-400">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="tag_id" id="tag_id" value="{{ old('tag_id', $gameFowl->tag_id) }}" class="pl-7 w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300 dark:focus:border-emerald-500 transition-shadow font-mono" required>
                        </div>
                        @error('tag_id')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $gameFowl->name) }}" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300 dark:focus:border-emerald-500 transition-shadow" required>
                        @error('name')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="lg:col-span-2 space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6" x-data="{ sex: '{{ old('sex', $gameFowl->sex) }}' }">
                        <!-- Sex -->
                        <div>
                            <label for="sex" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Sex</label>
                            <select name="sex" id="sex" x-model="sex" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300 dark:focus:border-emerald-500 transition-shadow" required>
                        ...
                        <div x-show="sex === 'Female'" style="display: none;">
                            ...
                            <select name="reproductive_status" id="reproductive_status_female" :disabled="sex !== 'Female'" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300 dark:focus:border-emerald-500 transition-shadow">
                                <option value="">Select Status</option>
                                <option value="Ready to Lay Eggs" {{ old('reproductive_status', $gameFowl->reproductive_status) == 'Ready to Lay Eggs' ? 'selected' : '' }}>Ready to Lay Eggs</option>
                                <option value="Too Young" {{ old('reproductive_status', $gameFowl->reproductive_status) == 'Too Young' ? 'selected' : '' }}>Too Young</option>
                                <option value="Not Applicable" {{ old('reproductive_status', $gameFowl->reproductive_status) == 'Not Applicable' ? 'selected' : '' }}>Not Applicable</option>
                                <option value="Already Laying" {{ old('reproductive_status', $gameFowl->reproductive_status) == 'Already Laying' ? 'selected' : '' }}>Already Laying</option>
                                <option value="Retired" {{ old('reproductive_status', $gameFowl->reproductive_status) == 'Retired' ? 'selected' : '' }}>Retired</option>
                            </select>
                        </div>
                        ...
                        <div x-show="sex === 'Male'" style="display: none;">
                            ...
                            <select name="reproductive_status" id="reproductive_status_male" :disabled="sex !== 'Male'" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300 dark:focus:border-emerald-500 transition-shadow">
                                <option value="">Select Status</option>
                                <option value="Ready to Breed" {{ old('reproductive_status', $gameFowl->reproductive_status) == 'Ready to Breed' ? 'selected' : '' }}>Ready to Breed</option>
                                <option value="Too Young" {{ old('reproductive_status', $gameFowl->reproductive_status) == 'Too Young' ? 'selected' : '' }}>Too Young</option>
                                <option value="Active Breeder" {{ old('reproductive_status', $gameFowl->reproductive_status) == 'Active Breeder' ? 'selected' : '' }}>Active Breeder</option>
                                <option value="Retired" {{ old('reproductive_status', $gameFowl->reproductive_status) == 'Retired' ? 'selected' : '' }}>Retired</option>
                                <option value="Not Applicable" {{ old('reproductive_status', $gameFowl->reproductive_status) == 'Not Applicable' ? 'selected' : '' }}>Not Applicable</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="gender_identification" id="gender_identification" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300 dark:focus:border-emerald-500 transition-shadow">
                                <option value="">Select Method</option>
                                <option value="Visual" {{ old('gender_identification', $gameFowl->gender_identification) == 'Visual' ? 'selected' : '' }}>Visual</option>
                                <option value="Vent Sexing" {{ old('gender_identification', $gameFowl->gender_identification) == 'Vent Sexing' ? 'selected' : '' }}>Vent Sexing</option>
                                <option value="Feather Sexing" {{ old('gender_identification', $gameFowl->gender_identification) == 'Feather Sexing' ? 'selected' : '' }}>Feather Sexing</option>
                                <option value="DNA" {{ old('gender_identification', $gameFowl->gender_identification) == 'DNA' ? 'selected' : '' }}>DNA</option>
                                <option value="Behavior" {{ old('gender_identification', $gameFowl->gender_identification) == 'Behavior' ? 'selected' : '' }}>Behavior</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="date" name="date_hatched" id="date_hatched" value="{{ old('date_hatched', $gameFowl->date_hatched->format('Y-m-d')) }}" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300 dark:focus:border-emerald-500 transition-shadow" required>
                            @error('date_hatched')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <select name="stage_growth_phase" id="stage_growth_phase" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300 dark:focus:border-emerald-500 transition-shadow" required>
                                ...
                                <option value="Brooder" {{ old('stage_growth_phase', $gameFowl->stage_growth_phase) == 'Brooder' ? 'selected' : '' }}>Brooder</option>
                                <option value="Starter" {{ old('stage_growth_phase', $gameFowl->stage_growth_phase) == 'Starter' ? 'selected' : '' }}>Starter</option>
                                <option value="Grower" {{ old('stage_growth_phase', $gameFowl->stage_growth_phase) == 'Grower' ? 'selected' : '' }}>Grower</option>
                                <option value="Stag" {{ old('stage_growth_phase', $gameFowl->stage_growth_phase) == 'Stag' ? 'selected' : '' }}>Stag</option>
                                <option value="Pullet" {{ old('stage_growth_phase', $gameFowl->stage_growth_phase) == 'Pullet' ? 'selected' : '' }}>Pullet</option>
                                <option value="Bullstag" {{ old('stage_growth_phase', $gameFowl->stage_growth_phase) == 'Bullstag' ? 'selected' : '' }}>Bullstag</option>
                                <option value="Cock" {{ old('stage_growth_phase', $gameFowl->stage_growth_phase) == 'Cock' ? 'selected' : '' }}>Cock</option>
                                <option value="Hen" {{ old('stage_growth_phase', $gameFowl->stage_growth_phase) == 'Hen' ? 'selected' : '' }}>Hen</option>
                                <option value="Retired" {{ old('stage_growth_phase', $gameFowl->stage_growth_phase) == 'Retired' ? 'selected' : '' }}>Retired</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="date" name="acquisition_date" id="acquisition_date" value="{{ old('acquisition_date', $gameFowl->acquisition_date->format('Y-m-d')) }}" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300 dark:focus:border-emerald-500 transition-shadow" required>
                        ...
                        <div>
                            ...
                            <select name="initial_health_status" id="initial_health_status" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300 dark:focus:border-emerald-500 transition-shadow" required>
                                <option value="">Select Status</option>
                                <option value="Healthy" {{ old('initial_health_status', $gameFowl->initial_health_status) == 'Healthy' ? 'selected' : '' }}>Healthy</option>
                                <option value="Weak / Underweight" {{ old('initial_health_status', $gameFowl->initial_health_status) == 'Weak / Underweight' ? 'selected' : '' }}>Weak / Underweight</option>
                                <option value="Sick" {{ old('initial_health_status', $gameFowl->initial_health_status) == 'Sick' ? 'selected' : '' }}>Sick</option>
                                <option value="Injured" {{ old('initial_health_status', $gameFowl->initial_health_status) == 'Injured' ? 'selected' : '' }}>Injured</option>
                                <option value="Dead" {{ old('initial_health_status', $gameFowl->initial_health_status) == 'Dead' ? 'selected' : '' }}>Dead</option>
                            </select>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select name="sexual_maturity_status" id="sexual_maturity_status" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300 dark:focus:border-emerald-500 transition-shadow" required>
                                <option value="">Select Status</option>
                                <option value="Immature" {{ old('sexual_maturity_status', $gameFowl->sexual_maturity_status) == 'Immature' ? 'selected' : '' }}>Immature</option>
                                <option value="Developing" {{ old('sexual_maturity_status', $gameFowl->sexual_maturity_status) == 'Developing' ? 'selected' : '' }}>Developing</option>
                                <option value="Mature" {{ old('sexual_maturity_status', $gameFowl->sexual_maturity_status) == 'Mature' ? 'selected' : '' }}>Mature</option>
                                <option value="Retired" {{ old('sexual_maturity_status', $gameFowl->sexual_maturity_status) == 'Retired' ? 'selected' : '' }}>Retired</option>
                            </select>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="special_notes" id="special_notes" rows="3" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300 dark:focus:border-emerald-500 transition-shadow">{{ old('special_notes', $gameFowl->special_notes) }}</textarea>
                            @error('special_notes')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
