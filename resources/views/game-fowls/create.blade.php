                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6" x-data="{ sex: '{{ old('sex') }}' }">
                        ...
                        <div>
                            ...
                            <select name="classification" id="classification" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300 dark:focus:border-emerald-500 transition-shadow">
                                ...
                                <option value="Brood Fowl" {{ old('classification') == 'Brood Fowl' ? 'selected' : '' }}>Brood Fowl (Breeder)</option>
                                <option value="Fighter" {{ old('classification') == 'Fighter' ? 'selected' : '' }}>Fighter</option>
                                <option value="Puller" {{ old('classification') == 'Puller' ? 'selected' : '' }}>Puller (Young)</option>
                        ...
                        <div>
                            ...
                            <select name="conditioning_status" id="conditioning_status" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300 dark:focus:border-emerald-500 transition-shadow">
                                <option value="">Select Status</option>
                                <option value="Not Applicable" {{ old('conditioning_status', 'Not Applicable') == 'Not Applicable' ? 'selected' : '' }}>Not Applicable</option>
                                <option value="Pre-Conditioning" {{ old('conditioning_status') == 'Pre-Conditioning' ? 'selected' : '' }}>Pre-Conditioning</option>
                                <option value="In Training" {{ old('conditioning_status') == 'In Training' ? 'selected' : '' }}>In Training</option>
                                <option value="Ready" {{ old('conditioning_status') == 'Ready' ? 'selected' : '' }}>Ready to Fight</option>
                        ...
                        <div class="md:col-span-2 border-t border-gray-200 dark:border-slate-700 pt-6 mt-2">
