<x-layouts.app>
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ route($routePrefix . 'fight-schedules.create', ['game_fowl_id' => $gameFowl->id]) }}" wire:navigate class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 focus:bg-blue-700 active:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 transition ease-in-out duration-150">
                {{ __('Schedule Fight') }}
            </a>
            @endif
        </div>
