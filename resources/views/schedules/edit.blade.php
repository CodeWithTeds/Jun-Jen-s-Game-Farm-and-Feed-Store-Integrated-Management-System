            ...
            <form method="POST" action="{{ route('schedules.update', $schedule->id) }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div class="col-span-2">
                        ...
                        <input id="title" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300 dark:focus:border-emerald-500 transition-shadow" type="text" name="title" value="{{ old('title', $schedule->title) }}" required autofocus />
                        @error('title')
