    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-2">
                <a href="{{ route('admin.suppliers.edit', $supplier->id) }}" wire:navigate class="inline-flex items-center px-4 py-2 bg-emerald-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-emerald-700 focus:bg-emerald-700 active:bg-emerald-900 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 transition ease-in-out duration-150">
                    {{ __('Edit') }}
                </a>
                        ...
                        <div class="bg-gray-50 dark:bg-slate-900 p-6 rounded-lg border border-slate-100 dark:border-slate-700/50">
                            ...
                            <dl class="grid grid-cols-1 gap-x-4 gap-y-6">
                                ...
                                <div>
                                    ...
                                    <dd class="mt-1 text-sm text-gray-900 dark:text-gray-200 whitespace-pre-line bg-white dark:bg-slate-800 p-3 rounded border border-gray-100 dark:border-slate-700">{{ $supplier->remarks ?? 'No remarks available.' }}</dd>
                                </div>
                            </dl>
                        </div>
                    </div>
