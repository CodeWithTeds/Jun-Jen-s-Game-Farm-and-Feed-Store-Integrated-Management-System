                    ...
                    <div class="bg-white dark:bg-slate-900 shadow-sm rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden">
                        ...
                        <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <input type="date" name="collection_date" id="collection_date" value="{{ old('collection_date', $eggCollection->collection_date) }}" class="block w-full rounded-lg border-gray-300 dark:border-slate-700 dark:bg-slate-900/50 dark:text-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm py-2.5" required>
                            </div>
                    ...
                    <div class="bg-white dark:bg-slate-900 shadow-sm rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden">
                        ...
                        <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <input type="date" name="incubation_start_date" id="incubation_start_date" value="{{ old('incubation_start_date', $eggCollection->incubation_start_date) }}" class="block w-full rounded-lg border-gray-300 dark:border-slate-700 dark:bg-slate-900/50 dark:text-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm py-2.5">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" name="expected_hatch_date" id="expected_hatch_date" value="{{ old('expected_hatch_date', $eggCollection->expected_hatch_date) }}" class="block w-full rounded-lg border-gray-300 dark:border-slate-700 dark:bg-slate-900/50 dark:text-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm py-2.5">
                            </div>
                            
                            <!-- Hatched Count -->
                            <div>
                                <label for="hatched_count" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Hatched Count</label>
                                <input type="number" name="hatched_count" id="hatched_count" value="{{ old('hatched_count', $eggCollection->hatched_count) }}" class="block w-full rounded-lg border-gray-300 dark:border-slate-700 dark:bg-slate-900/50 dark:text-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm py-2.5">
                            </div>
