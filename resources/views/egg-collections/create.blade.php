                    ...
                    <div class="bg-white dark:bg-zinc-900 shadow-sm rounded-xl border border-zinc-200 dark:border-zinc-800 overflow-hidden">
                        ...
                        <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <input type="date" name="collection_date" id="collection_date" value="{{ old('collection_date', date('Y-m-d')) }}" class="block w-full rounded-lg border-gray-300 dark:border-zinc-700 dark:bg-zinc-900/50 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm py-2.5" required>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="egg_count" id="egg_count" value="{{ old('egg_count') }}" min="1" class="block w-full rounded-lg border-gray-300 dark:border-zinc-700 dark:bg-zinc-900/50 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm py-2.5" required>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="collection_staff" id="collection_staff" value="{{ old('collection_staff', auth()->user()->name) }}" class="block w-full rounded-lg border-gray-300 dark:border-zinc-700 dark:bg-zinc-900/50 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm py-2.5" required>
                            </div>
                    ...
                    <div class="bg-white dark:bg-zinc-900 shadow-sm rounded-xl border border-zinc-200 dark:border-zinc-800 overflow-hidden">
                        ...
                        <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <input type="date" name="incubation_start_date" id="incubation_start_date" value="{{ old('incubation_start_date') }}" class="block w-full rounded-lg border-gray-300 dark:border-zinc-700 dark:bg-zinc-900/50 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm py-2.5">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" name="expected_hatch_date" id="expected_hatch_date" value="{{ old('expected_hatch_date') }}" class="block w-full rounded-lg border-gray-300 dark:border-zinc-700 dark:bg-zinc-900/50 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm py-2.5">
                            </div>
